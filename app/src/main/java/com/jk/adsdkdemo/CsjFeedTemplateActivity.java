...
import com.jk.adsdkdemo.dialog.DislikeDialog;
import com.jk.adsdkdemo.utils.TToast;
import com.jk.adsdkdemo.view.ILoadMoreListener;
import com.jk.adsdkdemo.view.LoadMoreListView;
...
/**
  ...
  * @Version:        1.0
 */
public class CsjFeedTemplateActivity extends AppCompatActivity {
    ...
    private void loadListAd() {
        ...
        mTTAdNative.loadNativeExpressAd(adSlot, new TTAdNative.NativeExpressAdListener() {
            ...
            public void onError(int code, String message) {
                ...
                TToast.show(CsjFeedTemplateActivity.this, message);
            }
            ...
            public void onNativeExpressAdLoad(List<TTNativeExpressAd> ads) {
                ...
                if (ads == null || ads.isEmpty()) {
                    TToast.show(CsjFeedTemplateActivity.this, "on FeedAdLoaded: ad is null!");
                    return;
                }
        ...
        for (TTNativeExpressAd ad : ads) {
            ...
            adTmp.setExpressInteractionListener(new TTNativeExpressAd.ExpressAdInteractionListener() {
                ...
                public void onAdClicked(View view, int type) {
                    TToast.show(CsjFeedTemplateActivity.this, "广告被点击");
                }

                @Override
                public void onAdShow(View view, int type) {
                    TToast.show(CsjFeedTemplateActivity.this, "广告展示");
                }

                @Override
                public void onRenderFail(View view, String msg, int code) {
                    TToast.show(CsjFeedTemplateActivity.this, msg + " code:" + code);
                }

                @Override
                public void onRenderSuccess(View view, float width, float height) {
                    //返回view的宽高 单位 dp
                    TToast.show(CsjFeedTemplateActivity.this, "渲染成功");
                    myAdapter.notifyDataSetChanged();
                }
            });
            ad.render();
