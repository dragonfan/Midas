...
public class AppInfoUtils {
    ...
    public static String getVersionName() {
        ...
        try {
            versionName = MainApp.getContext().getPackageManager().getPackageInfo(packageName, 0).versionName;
        } catch (Exception ex) {
            ex.printStackTrace();
        }
        return versionName;
    ...
    public static int getVersionCode() {
        int versionCode = 0;
        try {
            versionCode = MainApp.getContext().getPackageManager()
                    .getPackageInfo(MainApp.getContext().getPackageName(),
                            0).versionCode;
        } catch (Exception e) {
            versionCode = 0;
        }
