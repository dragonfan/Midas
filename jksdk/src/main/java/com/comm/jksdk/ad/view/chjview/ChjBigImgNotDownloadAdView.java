...
public class ChjBigImgNotDownloadAdView extends CommAdView {
    // 广告实体数据
    ...
    public ChjBigImgNotDownloadAdView(Context context) {
        super(context);
    ...
    public int getLayoutId() {
        return R.layout.chj_ad_big_not_download_layout;
    }
